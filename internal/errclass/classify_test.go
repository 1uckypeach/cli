...
func TestConsoleURL_FeishuBrand(t *testing.T) {
	...
	if !strings.Contains(pe.ConsoleURL, "open.feishu-boe.cn/page/scope-apply?clientID=cli_a123") {
		t.Fatalf("ConsoleURL = %q, want open.feishu-boe.cn scope-apply page", pe.ConsoleURL)
	}
}
