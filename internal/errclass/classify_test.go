...
func TestBuildAPIError_ExitCodeMatrix(t *testing.T) {
	cases := []struct {
		...
		{"800004006 common_invalid_params", 800004006, errs.CategoryAPI, errs.SubtypeInvalidParameters, 1, "APIError"},
		...
		{"800004011 base_agent_cli_entrance_disabled", 800004011, errs.CategoryAuthorization, errs.SubtypePermissionDenied, 3, "PermissionError"},
		{"800004907 base_agent_context_busy", 800004907, errs.CategoryAPI, errs.SubtypeConflict, 1, "APIError"},
		{"800004962 base_agent_credit_exhausted", 800004962, errs.CategoryAPI, errs.SubtypeQuotaExceeded, 1, "APIError"},
		{"800004991 base_agent_decision_quota_limit", 800004991, errs.CategoryAPI, errs.SubtypeQuotaExceeded, 1, "APIError"},
		{"800004906 base_agent_tns_blocked", 800004906, errs.CategoryPolicy, errs.SubtypeContentSafety, 6, "SecurityPolicyError"},
		{"800004932 base_agent_job_timeout", 800004932, errs.CategoryAPI, errs.SubtypeServerError, 1, "APIError"},
		{"800009999 base_agent_dependency_not_initialized", 800009999, errs.CategoryInternal, errs.SubtypeSDKError, 5, "InternalError"},
