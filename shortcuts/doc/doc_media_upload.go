...
var DocMediaUpload = common.Shortcut{
	...
	Flags: []common.Flag{
		{Name: "file", Desc: "local file path relative to the current working directory; absolute and out-of-tree paths are rejected (files > 20MB use multipart upload automatically)", Required: true},
