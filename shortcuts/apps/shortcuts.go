...
func Shortcuts() []common.Shortcut {
	envSet := withExtraTips(AppsEnvVarSet, "Example: lark-cli apps +env-set --app-id <app_id> --environment online --key FOO --value <value> --yes   # only after the user has confirmed")
