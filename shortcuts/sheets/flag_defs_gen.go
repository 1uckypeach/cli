...
var flagDefs = map[string]commandDef{
	...
	"+chart-config-update": {
		...
		Flags: []flagDef{
			...
			{Name: "data-labels", Kind: "own", Type: "string", Required: "optional", Desc: "Data label content; none removes labels", Enum: []string{"none", "value", "percentage", "value_percentage", "category", "series"}},
			...
			{Name: "smooth", Kind: "own", Type: "bool", Required: "optional", Desc: "Use smooth curves; false is accepted explicitly"},
	...
	"+chart-create-basic": {
		...
		Flags: []flagDef{
			...
			{Name: "data-range", Kind: "own", Type: "string", Required: "required", Desc: "Contiguous A1 data range including headers; at least 2 rows and 2 columns, or 3 rows/columns along the data direction for combo"},
