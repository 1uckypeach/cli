...
var flagDefs = map[string]commandDef{
	...
	"+cols-resize": {
		...
		Flags: []flagDef{
			...
			{Name: "sheet-id", Kind: "public", Type: "string", Required: "xor", Desc: "Sheet reference_id (XOR with `--sheet-name`)"},
			{Name: "sheet-name", Kind: "public", Type: "string", Required: "xor", Desc: "Sheet name (XOR with `--sheet-id`)"},
			{Name: "width", Kind: "own", Type: "int", Required: "xor", Desc: "Column width in pixels (e.g. 80 / 120 / 200). Passing --width implies pixel mode; --type may be omitted (or set to `pixel` — equivalent)", Default: "0"},
	...
	"+rows-resize": {
		...
		Flags: []flagDef{
			...
			{Name: "sheet-id", Kind: "public", Type: "string", Required: "xor", Desc: "Sheet reference_id (XOR with `--sheet-name`)"},
			{Name: "sheet-name", Kind: "public", Type: "string", Required: "xor", Desc: "Sheet name (XOR with `--sheet-id`)"},
			{Name: "height", Kind: "own", Type: "int", Required: "xor", Desc: "Row height in pixels (e.g. 30 / 40 / 60). Passing --height implies pixel mode; --type may be omitted (or set to `pixel` — equivalent)", Default: "0"},
