...
var flagDefs = map[string]commandDef{
	...
	"+chart-data-update": {
		...
		Flags: []flagDef{
			...
			{Name: "sheet-name", Kind: "public", Type: "string", Required: "xor", Desc: "Sheet name (XOR with `--sheet-id`)"},
			{Name: "chart-id", Kind: "own", Type: "string", Required: "required", Desc: "Target chart reference_id"},
			{Name: "data-range", Kind: "own", Type: "string", Required: "required", Desc: "New data range; include headers unless --header-range is set or the chart already uses detached headers; accepts comma-separated same-sheet ranges"},
