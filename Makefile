...
script-test:
	...
	$(NODE) --test scripts/e2e_domains.test.js scripts/install.test.js scripts/release-preflight.test.js scripts/verify-release-assets.test.js scripts/release-workflow.test.js scripts/semantic-review-verify-artifact.test.js scripts/pr-quality-summary.test.js scripts/semantic-review-publish.test.js scripts/ci-quality-summary-publish.test.js
